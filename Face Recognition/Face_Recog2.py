...
data_folder_path = 'E:/TA/Analytics/Work/Face Recognition/Training Data'
...
test_img1 = cv2.imread('1.jpeg')
test_img2 = cv2.imread('2.jpeg')
test_img3 = cv2.imread('3.jpeg')
test_img4 = cv2.imread('4.jpeg')
test_img5 = cv2.imread('5.jpeg')
